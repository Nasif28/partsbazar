...
const NotFoundPage = () => {
  ...
  return (
    <FrontendLayout>
      <div
        className="flex relative flex-col items-center justify-center p-8"
        style={{
      ...
      >
        ...
        <div className="max-w-3xl w-full text-center relative z-20">
          ...
          >
            <Button
              onClick={() => router.push("/")}
              className="py-8 my-6 px-12 font-bold text-lg transition-all transform hover:scale-105 shadow-lg"
              style={{
                background: "var(--primary)",
          ...
          {/* <motion.div
            className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-md mx-auto"
            initial={{ y: 50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
