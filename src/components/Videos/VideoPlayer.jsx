...
import { ArrowLeft, Share, ThumbsUp, Bookmark, Play } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="relative w-16 h-16 rounded-xl overflow-hidden border-2 border-dashed">
                <Image
          ...
          {relatedVideos.map((video) => (
            <div key={video.id} className="flex gap-3">
              <Link
                ...
                className="flex-shrink-0 relative w-40 aspect-video rounded-md overflow-hidden"
              >
                <Image
                  src={video.thumbnail}
                  alt={video.title}
